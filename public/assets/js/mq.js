const MQ = [
    ...
    },
    {
        ...
        chapteren: "Off to Toram",
        episode: 95,
        episodeid: "Manusia Naga dan Dunia Bawah Tanah",
    ...
    },
    {
        ...
        chapteren: "The Weredragon's Vital point",
        episode: 97,
        episodeid: "Rivalitas Antara Naga dan Weredragon",
        episodeen: "Rivalry Between Dragon and Weredragon",
        exp: 76300000,
    },
    {
        chapter: 12,
        ...
        chapteren: "The Weredragon's Vital point",
        episode: 98,
        episodeid: "Pasangan WereDragon dan se ekor bayi",
...
class Main {
    ...
    calculate() {
        ...
        if (start.episode == end.episode) {
            ...
            for (const mq of count) {
                ...
                if (mq.episode == end.episode) break;
            }
        }
    ...
    getResult() {
        ...
        d.innerHTML =
            "<strong>Level " + this.level + " (" + this.percent + "%)</strong>";
    }
