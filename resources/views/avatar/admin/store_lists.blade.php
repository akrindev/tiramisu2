...
@section('title', 'Tambah Avatar Lists')
...
@section('content')
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Avatar Lists</h1>
  </div>
    <div class="row">
      <div class="col-md-8">
        ...
        {!! form_open_multipart('/avatar/list/store', ['id' => 'store-form']) !!}
        ...
        <div class="form-group">
            <div class="form-label">Rating bintang</div>
              ...
              <div class="selectgroup selectgroup-pills">
                 <label class="selectgroup-item">
                     <input type="radio" name="rate" value="1" class="selectgroup-input" checked="">
                            <span class="selectgroup-button selectgroup-button-icon">1</span>
                 </label>

                 <label class="selectgroup-item">
                     <input type="radio" name="rate" value="2" class="selectgroup-input">
                            <span class="selectgroup-button selectgroup-button-icon">2</span>
                 </label>

                 <label class="selectgroup-item">
                     <input type="radio" name="rate" value="3" class="selectgroup-input">
                            <span class="selectgroup-button selectgroup-button-icon">3</span>
                 </label>
                 <label class="selectgroup-item">
                     <input type="radio" name="rate" value="4" class="selectgroup-input">
        ...
        <div class="form-group">
            ...
            <input type="file" name="image" class="form-control form-control-file" id="cover" accept="image/*" required/>
        </div>
...
<script>
  ...
  form.addEventListener('submit', e => {
    ...
    axios.post('/avatar/list/store', new FormData(e.target))
    .then((res) => {
    	if(res.data.success) {
