...
@section('content')
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Avatar</h1>
  </div>
    <div class="row">
      <div class="col-md-8">
        ...
        {!! form_open_multipart('/avatar/store', ['id' => 'store-form']) !!}
        ...
        <div class="form-group">
            ...
            <input type="file" name="cover" class="form-control form-control-file" id="cover" accept="image/*" required/>
        </div>
...
<script>
  ...
  form.addEventListener('submit', e => {
    ...
    axios.post('/avatar/store', new FormData(e.target))
    .then((res) => {
    	if(res.data.success) {
          swal('Data Avatar telah di tambahkan', {
          	icon: 'success'
          });
        }
