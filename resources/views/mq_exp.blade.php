                            ...
                            <div class="card-body p-2">
                                <table>
                                    <tbody>
                                        <tr>
                                            <th> Language </th>
                                            <td> <select name="locale" id="locale" class="form-control"
                                                    onchange="App.setLocale()">
                                        ...
                                        <tr>
                                            <th>Your Level</th>
                                            <td> <input type="number" class="form-control" id="level" value="50"
                                                    min=1 max=250 oninput="App.calculate()" /> </td>
                                        </tr>
                                        <tr>
                                            <th>Your Level %</th>
                                            <td> <input type="number" class="form-control" id="percent" value="1"
                                                    min=0 max=100 oninput="App.calculate()" /> </td>
                                        </tr>
                                        <tr>
...
@section('footer')
    ...
    <script src="/assets/js/mq.js?v042026"></script>
@endsection
