...
<div class="form-group">
  <div>
    <div class="input-icon">
      ...
      <input itemprop="query-input" type="search" name="q" class="form-control" placeholder="Nama item, weapon, armor, monster dll . . ." value="{{ request()->q ?? '' }}" pattern=".{2,}" title="2 karakter atau lebih" required>
    </div>
