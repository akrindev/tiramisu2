<div class="card">
  <div class="card-body p-2" style="font-size:13px;font-weight:400">
    ...
    <div class="my-1 row gutters-xs">
      ...
      <span class="d-block mb-1 col-6"><i class="fe fe-chevrons-right mr-1"></i><a href="/fill_stats/formula">Fill Stats Formula</a></span>
      <span class="d-block mb-1 col-6"><i class="fe fe-chevrons-right mr-1"></i><a href="/fill_stats/simulator">Fill Stat Simulator</a></span>
