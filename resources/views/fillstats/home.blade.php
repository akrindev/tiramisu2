...
@section('content')
    <div class="my-3 my-md-5">
        <div class="container">
            ...
            <div class="alert alert-info">
                Simulasi Fill Stats <a href="/fill_stats/simulator">Updated</a>
                <hr class="my-2" />
            ...
            <div class="alert alert-danger">
                Before using this statting simulator, ensure that you learn these statting skills (3 skills on the bottom)
                and level up to max level
    ...
    <button class="btn btn-md btn-primary" onclick="topFunction()" id="myBtn" title="Go to top"><i
            class="fe fe-arrow-up mr-2"></i>Ke Atas</button>
    <style>
        #myBtn {
            display: none;
            /* Hidden by default */
