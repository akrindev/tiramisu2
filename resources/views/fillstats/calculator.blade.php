            ...
            <div class="row">
                ...
                <div class="mb-5 col-12">
                    ...
                    <div class="alert alert-danger">
                        Before using this statting simulator, ensure that you learn these statting skills (3 skills on the
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input onclick="document.querySelector('#recipe_pot').value = 46" type="radio"
                                            value="w" class="selectgroup-input" checked="true" name="weap_arm"
                                            id="weap_arm">
                                        <span class="selectgroup-button selectgroup-button-icon">Weapon</span>
                                    </label>

                                    <label class="selectgroup-item">
                                        <input onclick="document.querySelector('#recipe_pot').value = 44" type="radio"
                                            value="a" checked="false" class="selectgroup-input" name="weap_arm"
                                            id="weap_arm">
  ...
  [Pedang Vulture]</pre>
                            ...
                            <div class="form-group">
                                <details>
                                    ...
                                    <input type="number" name="tec" id="tec" min=0 max=255 class='form-control'
                                        value=255>
                                    <label for="proficiency">Proficiency</label>
                                    <input type="number" name="proficiency" id="proficiency" min=0 max=250
                            ...
                            <div class="mt-3">
                                <small class="text-muted">Credit: <a
                                        href="https://sparkychildcharlie.github.io/statting_simulator" rel="nofollow"
                                        target="_blank">Charlie Kobayashi</a></small>
                                <div class="my-1">
                        ...
                        <div class="card">
                            ...
                            <div class="p-3 card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="note" maxlength="40"
                                        placeholder="title max 40 charachter">
                                </div>
                                @if (!session()->has('data'))
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-pill" id="save"
                                            onClick="Cloud.send()">Save</button>
                                ...
                                <div class="dimmer">
                                    ...
                                    <div class="dimmer-content">
                                        <div id="saved-formula" class="o-auto" style="height: 160px">
                                            Save public atau <a href="/fb-login">Login</a> untuk melihat formula yang telah
                                            kamu simpan <br />
                                        </div>
                ...
                <div class="hidden mb-5 col-md-7" id="show-formula">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-options"> <button class="btn btn-sm btn-outline-primary"
                                    onclick="document.getElementById('wk').scrollIntoView();document.getElementById('note').focus()">save</button>
                            </div>
                        </div>
                        <div class="row p-3">
