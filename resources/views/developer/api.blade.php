...
axios.get('https://toram-id.space/api/v1/items')
...
.catch((err) => console.error(err));</code></pre>
            ...
            <p>
                ...
                <ul>
                    <li>
                        ...
                        <code>GET https://toram-id.space/api/v1/items</code> <br>
                        <details>
                            <summary>
                            ...
                            <pre><code class="language-json">[
        {
            ...
            "drop_type": {
                ...
                "url": "https:\/\/toram-id.space\/img\/drop\/tambahan.jpg"
            },
            "monsters": []
        },
        ...
                    ...
                    <li>
                        ...
                        <code>GET https://toram-id.space/api/v1/items/type</code> <br>
                        <details>
                            <summary>
                                <strong>Contoh response</strong> <br>
                            </summary>
                            <pre><code class="language-json">[
        {
            "id": 1,
            "name": "logam",
            "url": "https:\/\/toram-id.space\/img\/drop\/logam.png"
        },
        {
            "id": 2,
            "name": "kain",
            "url": "https:\/\/toram-id.space\/img\/drop\/kain.png"
        },
        {
            "id": 3,
            "name": "fauna",
            "url": "https:\/\/toram-id.space\/img\/drop\/fauna.png"
        },
        ...
    ]</code></pre>
                        </details>
                    ...
                    <li>
                        ...
                        <code>GET https://toram-id.space/api/v1/items/{items_type}</code> <br>
                        <code>GET https://toram-id.space/api/v1/items/31</code> <br>
                        <details>
                            <summary>
                                <strong>Contoh response</strong> <br>
                            </summary>
        ...
        "data": [
            {
                ...
                "drop_type": {
                    "id": 31,
                    "name": "zirah",
                    "url": "https:\/\/toram-id.space\/img\/drop\/zirah.jpg"
                },
                "monsters": []
            },
            ...
                    ...
                    <li>
                        ...
                        <code>GET https://toram-id.space/api/v1/item/{item_id}</code> <br>
                        <code>GET https://toram-id.space/api/v1/item/2000</code> <br>
                        <details>
                            <summary>
                                <strong>Contoh response</strong> <br>
                            </summary>
        ...
        "drop_type": {
            "id": 4,
            "name": "kayu",
            "url": "https:\/\/toram-id.space\/img\/drop\/kayu.png"
        },
        "monsters": [],
    }</code></pre>
                        </details>
                    ...
                    <li>
                        ...
                        <code>GET https://toram-id.space/api/v1/items/search/{query}</code> <br>
                        <code>GET https://toram-id.space/api/v1/items/search/bunga</code> <br>
                        <details>
                            <summary>
                                <strong>Contoh response</strong> <br>
                            </summary>
        ...
        "data": [
            {
                ...
                "picture": "https:\/\/toram-id.space\/imgs\/mobs\/bunga-akakuefkfw.png",
                "fullimage": null,
                "released": null,
                "drop_type": {
                    "id": 33,
                    "name": "Perkakas Tambahan",
                    "url": "https:\/\/toram-id.space\/img\/drop\/pelengkap.jpg"
                },
                "monsters": []
            },
            {
                ...
                "drop_type": {
                    "id": 16,
                    "name": "box b",
                    "url": "https:\/\/toram-id.space\/img\/drop\/box_b.jpg"
                },
                "monsters": [
                    {
                        "id": 50,
                        ...
                        "xp": 38,
                        "pet": "n",
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/fimera-42180.png",
                        "pivot": {
                            "drop_id": 1019,
                            "monster_id": 50
                        },
                    ...
                    },
                    {
                        ...
                        "xp": null,
                        "pet": "y",
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/nepenthe-62029.png",
                        "pivot": {
                            "drop_id": 1019,
                            "monster_id": 277
                        },
                    ...
                    },
                    {
                        ...
                        "xp": null,
                        "pet": "y",
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/nepenthe-54493.png",
                        "pivot": {
                            "drop_id": 1019,
                            "monster_id": 278
                        },
                    ...
                    },
                    {
                        ...
                        "xp": null,
                        "pet": "y",
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/nepenthe-88760.png",
                        "pivot": {
                            "drop_id": 1019,
                            "monster_id": 279
                        },
                    ...
                    },
                    {
                        ...
                        "xp": null,
                        "pet": "y",
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/floral-bee-51123.png",
                        "pivot": {
                            "drop_id": 1019,
                            "monster_id": 337
                        },
                    ...
                    },
                    {
                        ...
                        "xp": 44880,
                        "pet": "n",
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/lobalawar-91091.png",
                        "pivot": {
                            "drop_id": 1019,
                            "monster_id": 1128
                        },
            ...
            },
            {
                ...
                "drop_type": {
                    "id": 5,
                    "name": "obat",
                    "url": "https:\/\/toram-id.space\/img\/drop\/obat.png"
                },
                "monsters": [
                    {
                        "id": 70,
                        ...
                        "xp": 184,
                        "pet": "y",
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/mewte-99639.png",
                        "pivot": {
                            "drop_id": 1026,
                            "monster_id": 70
                        },
                    ...
                    },
                    {
                        ...
                        "xp": 202,
                        "pet": "y",
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/mewte-77455.png",
                        "pivot": {
                            "drop_id": 1026,
                            "monster_id": 71
                        },
        ...
        "first_page_url": "https:\/\/toram-id.space\/api\/v1\/items\/search\/bunga?page=1",
        "from": 1,
        "last_page": 2,
        "last_page_url": "https:\/\/toram-id.space\/api\/v1\/items\/search\/bunga?page=2",
        "links": [
            {
                "url": null,
            ...
            {
                "url": "https:\/\/toram-id.space\/api\/v1\/items\/search\/bunga?page=1",
                "label": "1",
                "active": true
            },
            {
                "url": "https:\/\/toram-id.space\/api\/v1\/items\/search\/bunga?page=2",
                "label": "2",
                "active": false
            },
            {
        ...
        "next_page_url": "https:\/\/toram-id.space\/api\/v1\/items\/search\/bunga?page=2",
        "path": "https:\/\/toram-id.space\/api\/v1\/items\/search\/bunga",
        "per_page": 15,
        "prev_page_url": null,
        "to": 15,
        "total": 17
                    ...
                    <li>
                        ...
                        <code>GET https://toram-id.space/api/v1/monsters</code> <br>
                        tampilkan berdasarkan level <br>
                        <code>GET https://toram-id.space/api/v1/monsters?level=120</code> <br>
                        tampilkan berdasarkan level dan rentang level <br>
                        <code>GET https://toram-id.space/api/v1/monsters?level=120&between=8</code> <br>
                        <details>
                            <summary>
                                <strong>Contoh response</strong> <br>
                            </summary>
                            <pre><code class="language-json">[
        {
            ...
            "xp": 20600,
            "pet": "y",
            "picture": "https:\/\/toram-id.space\/imgs\/mobs\/velum13Grypng",
            "element": {
                "id": 7,
                "name": "netral"
            }
        ...
        ...
                ...
                <li>
                    ...
                    <br>
                    <code>GET https://toram-id.space/api/v1/monsters/{jenis_id}</code> <br>
                    <code>GET https://toram-id.space/api/v1/monsters/3</code>
                        tampilkan berdasarkan level <br>
                        <code>GET https://toram-id.space/api/v1/monsters/3?level=120</code> <br>
                        tampilkan berdasarkan level dan rentang level <br>
                        <code>GET https://toram-id.space/api/v1/monsters/3?level=120&between=8</code> <br>
                    <details>
                        <summary>
                            <strong>Contoh response</strong> <br>
                        </summary>
        ...
        "data": [
            {
                ...
                "drops": [
                    ...
                    <li>
                        ...
                        <code>GET https://toram-id.space/api/v1/monster/{monster_id}</code> <br>
                        <details>
                            <summary>
                                <strong>Contoh response</strong> <br>
                            </summary>
        ...
        "drops": [
            {
                ...
                "drop_type": {
                    "id": 46,
                    "name": "panah",
                    "url": "https:\/\/toram-id.space\/img\/drop\/panah.jpg"
                }
            },
            {
                "id": 647,
                ...
                "picture": "https:\/\/toram-id.space\/imgs\/mobs\/topi-gotik-54721.png",
                "fullimage": null,
                "released": null,
                "pivot": {
                    "monster_id": 500,
        ...
        "map": {
            ...
            "name_en": "Dark Castle: Area 2"
                    ...
                    <li>
                        ...
                        <code>GET https://toram-id.space/api/v1/monsters/search/{query}</code> <br>
                        <code>GET https://toram-id.space/api/v1/monsters/search/machina</code> <br>
                        <details>
                            <summary>
                                <strong>Contoh response</strong> <br>
                            </summary>
                ...
                "drops": [
                    {
                        ...
                        "picture": "https:\/\/toram-id.space\/imgs\/mobs\/tombak-paladin-54912.png",
                        "fullimage": null,
                        "released": null,
                        "pivot": {
                            "monster_id": 6,
                        ...
                        "drop_type": {
                            "id": 29,
                            "name": "tombak",
                            "url": "https:\/\/toram-id.space\/img\/drop\/tombak.jpg"
                        }
                    },
                    {
                        "id": 964,
        ...
        "first_page_url": "https:\/\/toram-id.space\/api\/v1\/monsters\/search\/machina?page=1",
        "from": 1,
        "last_page": 4,
        "last_page_url": "https:\/\/toram-id.space\/api\/v1\/monsters\/search\/machina?page=4",
        "links": [
            {
                "url": null,
                "label": "&laquo; Previous",
            ...
            {
                "url": "https:\/\/toram-id.space\/api\/v1\/monsters\/search\/machina?page=1",
                "label": "1",
                "active": true
            },
            {
                "url": "https:\/\/toram-id.space\/api\/v1\/monsters\/search\/machina?page=2",
                "label": "2",
                "active": false
            },
            {
                "url": "https:\/\/toram-id.space\/api\/v1\/monsters\/search\/machina?page=3",
                "label": "3",
                "active": false
            },
            {
                "url": "https:\/\/toram-id.space\/api\/v1\/monsters\/search\/machina?page=4",
                "label": "4",
                "active": false
            },
            {
        ...
        "next_page_url": "https:\/\/toram-id.space\/api\/v1\/monsters\/search\/machina?page=2",
        "path": "https:\/\/toram-id.space\/api\/v1\/monsters\/search\/machina",
        "per_page": 15,
        "prev_page_url": null,
        "to": 15,
        "total": 57
