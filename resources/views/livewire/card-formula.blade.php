    ...
    <div class="card">
        ...
        <div class="p-2 card-body">
            ...
            <div class="mt-2">
                ...
                <a wire:click.prevent="show({{ $formula->id }})" wire:loading.class="btn-loading bg-primary" href="/fill_stats/show/{{ $formula->id }}" class="float-right mx-1 btn btn-sm btn-pill btn-outline-primary">Show</a>
            </div>
        </div>
    </div>
</div>
