...
{{--   
   ...
   --}}
            ...
            <div class="form-group" wire:ignore>
              ...
              <div id="preview"></div>
              <input type="file" wire:model.defer="picture" name="picture" class="form-control" accept="image/*" id="picture">
            </div>
  
            <div class="form-group" wire:ignore>
              <label class="form-label">Screenshot full image for armor</label>
              <div id="preview2"></div>
              <input type="file" wire:model.defer="fullimage" name="fullimage" class="form-control" accept="image/*" id="fullimage">
            </div>
