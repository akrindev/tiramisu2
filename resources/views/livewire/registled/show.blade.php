        ...
        <div class="card">
            <div class="card-body text-wrap p-2" style="font-size: 14px; font-weight: 400">
                ...
                <div class="d-block mb-1">
                    <img class="avatar avatar-sm float-left mr-3" src="{{ $registled->dropType->url }}" />
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        @if ($registled->registled->chest ?? false)
                            ...
                            @forelse(array_keys($registled->registled->box) as $box)
                                <span class="image">
                                    <img src="/img/drop/{{ $box }}.jpg" class="mb-1 mr-1" width="30px"
                                        height="30px" />
                                </span>
                            @empty
                            @endforelse
                    ...
                    <div class="col-12 mt-5">
                        ...
                        {{ toHtml(translate(optional($registled->note)['monster']), true) }}
                    </div>
