                ...
                <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="number" name="level" placeholder="levelmu" class="form-control"
                                                value="{{ request('level') }}" min="1" max="300" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="number" class="form-control text-right"
                                                    placeholder="Bonus EXP Gain %" aria-label="Bonus EXP GAIN"
                                                    name="bonusexp" min="0" max="1000000"
                                                    value="{{ request('bonusexp') }}">
                                    ...
                                    <div class="col-sm-12 col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="selectgroup w-100">
                                                ...
                                                <label class="selectgroup-item">
                                                    <input type="radio" name="range" value="6"
                                                        class="selectgroup-input"
                                                        {{ request('range') == 6 ? 'checked' : '' }}>
                                                    <span class="selectgroup-button">6</span>
                                                </label>

                                                <label class="selectgroup-item">
                                                    <input type="radio" name="range" value="7"
                                                        class="selectgroup-input"
                                                        {{ request('range') == 7 ? 'checked' : '' }}>
                                                    <span class="selectgroup-button">7</span>
                                                </label>

                                                <label class="selectgroup-item">
                                                    <input type="radio" name="range" value="8"
                                                        class="selectgroup-input"
                                                        {{ request('range') == 8 ? 'checked' : '' }}>
                                                    <span class="selectgroup-button">8</span>
                                                </label>

                                                <label class="selectgroup-item">
                                                    <input type="radio" name="range" value="9"
                                                        class="selectgroup-input"
                                                        {{ request('range') == 9 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        ...
                                        <button class="btn btn-outline-primary btn-block" type="submit"> <i
                                                class="fe fe-search"></i> Cari </button>
                                    </div>

                                    <div class="col-12">
                                        <hr class="my-1">
                                        <small class="help-block"><b>Note</b> jarak bonus dari level monster telah di <a
                                                href="http://id.toram.jp/information/detail/?information_id=4580"
                                                rel="nofollow">update pada maintenance kamis, 18 juli 2019</a>, antara
                                            +/-9</small>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body p-3">
                            ...
                            <span class="text-center d-block">Butuh <b
                                    class="text-primary"><u>{{ number_format($expNeed) }}</u></b> EXP</span>
                        ...
                        <div class="card-table">
                            <ul class="nav nav-tabs justify-content-center m-0" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="leveling-tab" data-toggle="tab" href="#leveling"
                                        role="tab" aria-controls="leveling" aria-selected="true">
                                        Leveling list</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="info-tab" data-toggle="tab" href="#info" role="tab"
                                        aria-controls="info" aria-selected="false">Bonus EXP Gain %
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="leveling" role="tabpanel"
                                    aria-labelledby="leveling-tab">

                                    <livewire:leveling :level="request('level', 60)" :bonusexp="request('bonusexp', 0)" :range="request('range', 5)" />
                                </div>
                                <!-- info exp gain -->
                                <div class="tab-pane fade" id="info" role="tabpanel" aria-labelledby="info-tab">
                                    <div class="p-3" style="font-size:14px;font-weight:400">
                                        ...
                                        - Membunuh 30 mobs yang levelnya 30 level lebih tinggi/rendah dari levelmu =
                                        <b>10%</b> EXP <br>

                                        - Membunuh 60 mobs yang levelnya 20 level lebih tinggi/rendah dari levelmu =
                                        <b>10%</b> EXP <br>

                                        - Membunuh 90 mobs yang levelnya 10 level lebih tinggi/rendah dari levelmu =
                                        <b>10%</b> EXP <br>

                                        <br><br>
                                        <strong>Level pemain</strong> <br>
                                        - Mencapai level 30, EXP Gain +10% &lt; levelmu <br> - Mencapai level 60, EXP Gain
                                        +11% &lt; levelmu <br> - Mencapai level 90, EXP Gain +12% &lt; levelmu <br> -
                                        Mencapai level 120, EXP Gain +13% &lt; levelmu <br> - Mencapai level 150, EXP Gain
                                        +14% &lt; levelmu <br> - Mencapai level 180, EXP Gain +15% &lt; levelmu <br><br>
                                        Total dari emblem level jika telah mencapai level 180 adalah <b>75%</b>.
                                        <br><br>
                                        - Skill EXP Gain level 10 = <b>10%</b> EXP Gain. <br><br>

                                        <b>Total</b> jika kamu telah membuka semua emblem di atas adalah <b>125%</b> EXP
                                        Gain. jika di tmbah dengan skill EXP Gain Lv 10 adalah <b>135%</b> EXP Gain.
